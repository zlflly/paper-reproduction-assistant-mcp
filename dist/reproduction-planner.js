...
exports.ReproductionPlanner = void 0;
class ReproductionPlanner {
    paperInfo;
    userProfile;
    constructor(paperInfo, userProfile) {
    ...
    adjustMilestonesForUser(milestones) {
    ...
    estimateTimeline() {
        ...
        let baseWeeks = 2;
        if (paperDifficulty === '高级')
            baseWeeks += 2;
        if (experienceLevel === '初学者')
            baseWeeks += 1;
        if (experienceLevel === '专家')
            baseWeeks -= 0.5;
    ...
    assessDifficulty() {
        const experienceLevel = this.userProfile.experience_level;
        const paperDifficulty = this.paperInfo.difficulty;
        if (experienceLevel === '初学者' && paperDifficulty === '高级')
            return '困难';
        if (experienceLevel === '专家' && paperDifficulty === '初级')
            return '简单';
        return '中等';
    }
}
exports.ReproductionPlanner = ReproductionPlanner;
//# sourceMappingURL=reproduction-planner.js.map